...
public class EvitandoSQLInjection {
	public static void main(String[] args) throws SQLException {
		...
		c.setAutoCommit(false); // -> caso esteja DESCOMENTADO, o programa irá alterar o bd. comentado, não é
								// possível
		// inserir automaticamente as alterações no banco (porém, o programa roda)

		// PreparedStatement > evita sql injection, já que entende qualquer informação
		// como string
		...
		c.commit(); // usa-se em conjunto com o setAutoCommit(false). caso o script rode certo,
					// deve-se usar o commit(), caso
		...
		c.close();
		ps.close(); // não precisa ser explicito, porém, não fechar pode acarretar em problemas de
